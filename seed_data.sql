...
-- 3. BƠM HÌNH ẢNH (Gắn đủ cho 20 sản phẩm)
...
-- 4. BƠM LỊCH SỬ NHẬP HÀNG (Làm mẫu cho 3 sản phẩm)
INSERT INTO "ImportLogs" ("Id", "ProductId", "QuantityAdded", "ActualImportPrice", "CreatedAt") VALUES 
(gen_random_uuid(), 'aaaa0001-0000-0000-0000-000000000000', 100, 8000, NOW()),
(gen_random_uuid(), 'aaaa0002-0000-0000-0000-000000000000', 100, 8000, NOW()),
(gen_random_uuid(), 'aaaa0006-0000-0000-0000-000000000000', 200, 16000, NOW());

-- 5. BƠM ĐƠN HÀNG & CHI TIẾT ĐƠN HÀNG (2 Đơn mẫu để test Lợi nhuận)
...
-- 6. BƠM TÀI KHOẢN USER (Pass đăng nhập mặc định: admin123)
INSERT INTO "Users" ("Id", "Username", "PasswordHash", "HasCompletedOnboarding", "ItemsPerPage", "IsDarkMode", "RememberLastSession") VALUES 
(gen_random_uuid(), 'admin', '$2a$11$wEFEI4h/mUj3R7YnSgXv/uY6A7yN2X2x6.fH.zVf5Qy3.Xm5j3C2m', true, 20, false, true);